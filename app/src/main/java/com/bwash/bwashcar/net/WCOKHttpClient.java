package com.bwash.bwashcar.net;
...
public class WCOKHttpClient extends OkHttpClient {
    ...
    public <T> Call requestAsyn( boolean stormFlag, String actionUrl, int requestType, HashMap<String, String> paramsMap, ReqCallBack<T> callBack) {
        Call call = null;
        switch (requestType) {
            case TYPE_GET:
