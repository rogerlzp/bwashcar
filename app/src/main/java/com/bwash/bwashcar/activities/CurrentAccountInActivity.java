...
import com.bwash.bwashcar.model.CurrentAccount;
...
import com.bwash.bwashcar.view.TrustView;
...
public class CurrentAccountInActivity extends BaseActivity implements TrustView.OnTrustCheckChanged {
    ...
    private void initView() {
        ...
        current_account.setText("￥" + com.bwash.bwashcar.utility.TextUtils.formatDoubleValue(availableAmount));
        findViewById(R.id.back_btn).setOnClickListener(this);
        ((TextView) findViewById(R.id.title)).setText(R.string.current_account_in_title);
        money_edit.setHint("剩余金额:" + com.bwash.bwashcar.utility.TextUtils.formatDoubleValue(currentRemainAmount));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.submit:
                ...
                if(!com.bwash.bwashcar.utility.TextUtils.checkNum(account)){
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject jsonObject) {
                        ...
                        try {
                            ...
                            if (resultCode.equals(LTNConstants.MSG_SUCCESS)) {
                                ...
                                current_account.setText("￥" + com.bwash.bwashcar.utility.TextUtils.formatDoubleValue(currentAccount.available_amount));
