...
import com.bwash.bwashcar.utility.PasswordUtil;
...
//                }
    ...
    public void getCaptcha() {
        ...
        map.put(LTNConstants.MOBILE_NO, "=" + mMobileNo);
        map.put(LTNConstants.SEND_TYPE, "=" + LTNConstants.SENT_TYPE_FORGET_PASSWORD);
        ...
        mReqParams.add(LTNConstants.MOBILE_NO, mMobileNo);
        mReqParams.add(LTNConstants.SEND_TYPE, LTNConstants.SENT_TYPE_FORGET_PASSWORD);
