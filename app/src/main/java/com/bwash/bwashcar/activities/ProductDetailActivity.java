...
import com.bwash.bwashcar.model.Coupon;
import com.bwash.bwashcar.model.Product;
import com.bwash.bwashcar.model.PurchaseRecord;
...
import com.bwash.bwashcar.utility.UserUtils;
...
import com.bwash.bwashcar.view.TipsPopupWindowUtils;
...
public class ProductDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    com.bwash.bwashcar.view.MyProgressBar pbBuyProgress;
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getBooleanExtra(LTNConstants.IS_REGISTER, false)) {
                com.bwash.bwashcar.utility.Utils.showRealNameWarn(ProductDetailActivity.this);
            }
        }
    };
                        ...
                        try {
                            ...
                            if (resultCode.equals(LTNConstants.MSG_SUCCESS)) {
                                ...
                                if (recordList != null && recordList.size() > 0) {
                                    ...
                                    tvRecordValue.setText(com.bwash.bwashcar.utility.TextUtils.replaceStarToString(pr.getUserName()) + " 投资 "
                                    );
                                } else {
                                    // TODO: 确认没有购买记录的时候怎么改
    ...
    public void initView() {
        pbBuyProgress = (com.bwash.bwashcar.view.MyProgressBar) findViewById(R.id.pb_buyProgress);
    ...
    public void initData() {
        ...
        tvStaInvestAmount.setText("" + com.bwash.bwashcar.utility.TextUtils.formatDoubleValueWithUnit(productTotalAmount));
        ...
        tvProductRemainAmount.setText("" + com.bwash.bwashcar.utility.TextUtils.formatDoubleValue(productRemainAmount) + "元");
        ...
        if (staRateDate.length() > 10) {
            ...
            tvStaRateDate.setText(com.bwash.bwashcar.utility.TextUtils.convertDateToFromat1(staRateDate));
        }
        ...
        tvProgressValue.setText(com.bwash.bwashcar.utility.TextUtils.formatDoubleValue(dProgress) + "%");

        // 截止时间
        if (raiseEndDate.length() > 10) {
            tvDetailDeadlineValue.setText(raiseEndDate.substring(0, 10) + "截止");
        } else {
            tvDetailDeadlineValue.setText(com.bwash.bwashcar.utility.TextUtils.convertDateToFromat1(raiseEndDate) + "截止");
        }
        tv_deadlin_day.setText(productDeadlineUnit);
