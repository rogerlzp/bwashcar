...
import com.bwash.bwashcar.adapter.ShopServiceAdapter;
import com.bwash.bwashcar.application.LTNApplication;
import com.bwash.bwashcar.eventtype.ShopServiceReserveEvent;
...
public class ShopDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initData() {
        ...
        if (distance % 1000 != 0) {
            ...
            tv_distance.setText(tv_distance + "米");
        }
        rb_rating.setRating(rating);
        ImageLoaderProxy.getInstance().displayImage(ShopDetailActivity.this, primaryPic, placeholder, R.drawable.ic_image_holder);
      //  placeholder.setImageURI(primaryPic);
    }
