...
import com.bwash.bwashcar.fragment.ChooseCouponDialogFragment;
import com.bwash.bwashcar.fragment.ProductBuySuccessFragment;
...
//                Bundle b = getIntent().getBundleExtra(LTNConstants.BUNDLE_OBJ);
    ...
    public void initView() {
        ...
        tbBirdCoin.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                tvBuyAmount.setText("实付金额：" + com.bwash.bwashcar.utility.TextUtils.formatDoubleValue(((double) Integer.parseInt(orderAmount) - birdCoinAmount)) + "元");
            }
        });
    }
    ...
    public void initData() {
        ...
        if (availableCoinAmount == 0) {
            ...
            tvBirdcoin.setText("可用" + com.bwash.bwashcar.utility.TextUtils.formatDoubleValue(birdCoinAmount) + "鸟币抵扣" + com.bwash.bwashcar.utility.TextUtils.formatDoubleValue(birdCoinAmount) + "元");
        }
