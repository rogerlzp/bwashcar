...
import com.bwash.bwashcar.activities.base.BaseFragmentActivity;
import com.bwash.bwashcar.application.LTNApplication;
import com.bwash.bwashcar.fragment.LTNAccountFragment;
import com.bwash.bwashcar.fragment.LTNHomeFragment;
import com.bwash.bwashcar.fragment.LTNInvestimentFragment;
import com.bwash.bwashcar.fragment.LTNMoreFragment;
...
import com.bwash.bwashcar.view.MyImageButtonWithText;
...
public class MainActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    private MyImageButtonWithText idMonitor;
    ...
    private LTNMoreFragment moreFragment;
...
//        }
        ...
        switch (position) {
            ...
            case 3:
                if (null == moreFragment) {
                    moreFragment = new LTNMoreFragment();
                    initAddFragment(R.id.lay_content_container, moreFragment);
                }
    ...
    private void setItBgAllToGray() {
        ...
        idMonitor.setImageResource(R.drawable.tab_about_normal);
        ...
        idMonitor.setTextViewTextColor(ContextCompat.getColor(this, R.color.text_gray_6));
    ...
    private void setItBgColor(int currentSelected) {
        ...
        switch (currentSelected) {
            case 0:
                ...
                idHome.setTextViewTextColor(ContextCompat.getColor(this, R.color.main_text_s_color));
                break;
            case 1:
                idWorkOrder.setImageResource(R.drawable.tab_list_selected);
                idWorkOrder.setTextViewTextColor(ContextCompat.getColor(this, R.color.main_text_s_color));
                break;
            case 2:
                idScan.setImageResource(R.drawable.tab_account_selected);
                idScan.setTextViewTextColor(ContextCompat.getColor(this, R.color.main_text_s_color));
                break;
            case 3:
                idMonitor.setImageResource(R.drawable.tab_about_selected);
                idMonitor.setTextViewTextColor(ContextCompat.getColor(this, R.color.main_text_s_color));
                break;
            default:
                break;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if ((System.currentTimeMillis() - mExitTime) > 2000) {
                ...
                Toast.makeText(this, "再按一次退出领投鸟", Toast.LENGTH_SHORT).show();
