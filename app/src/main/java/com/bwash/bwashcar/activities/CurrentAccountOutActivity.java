...
public class CurrentAccountOutActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        current_account.setText("￥" + com.bwash.bwashcar.utility.TextUtils.formatDoubleValue(currentHoldAmount));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.submit:
                ...
                if(!com.bwash.bwashcar.utility.TextUtils.checkNum(amount)){
