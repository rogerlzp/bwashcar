...
public class SeekArc extends View {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		int arcColor = res.getColor(R.color.seekarc_progress_gray);
		int progressColor = res.getColor(R.color.main_text_s_color);
		int thumbHalfheight = 0;
		int thumbHalfWidth = 0;
		mThumb = res.getDrawable(R.drawable.stroke_circle_orange_bg);
