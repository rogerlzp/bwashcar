...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private float indicatorOffWidth = 0f;
...
//	private int tabTextColor = 0xFF666666;
	...
	private int tabBackgroundResId = R.drawable.transparent_background;
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (pager.getAdapter() instanceof IconTabProvider) {
				...
				tab.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(((IconTabProvider)pager.getAdapter()).getPageIconResId(i)), null, null, null);
