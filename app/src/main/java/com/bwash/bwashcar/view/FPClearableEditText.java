 ...
 */
public class FPClearableEditText extends RelativeLayout {
    ...
    public FPClearableEditText(Context context) {
        super(context);
        init(null);
    }


    public FPClearableEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);

    }

    public FPClearableEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.view_edittext_clearable_forgetpwd, this, true);
