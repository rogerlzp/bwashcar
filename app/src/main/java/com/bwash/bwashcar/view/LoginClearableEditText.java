 ...
 */
public class LoginClearableEditText extends RelativeLayout {
    ...
    public LoginClearableEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);

    }

    public LoginClearableEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.view_edittext_clearable_login, this, true);
